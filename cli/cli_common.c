...
void print_usage(void) {
  printf("\n"
         ...
         "  synth generate --prompt <prompt.txt> -o out/\n"
         "  synth generate --prompt-text \"...\" -o out/\n"
         "  synth generate --prompt <prompt.txt> --offline-prompt -o out/\n"
         ...
         "\n"
         "Parse (deterministic offline NLP):\n"
         "  synth parse --prompt-text \"...\" [-o ir.json]\n"
